 ...
 * @param <D> DTO type
 */
public abstract class CrudController<ID extends Serializable, E extends Identifiable<ID>, D, R
        extends CrudRepository<ID, E>, S extends CrudService<ID, E, R>> extends BaseController<ID, E, D> {
